...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    System.out.print("Digite o formato do material a ser adicionado: ");
                    ...
                    if (opcao == 1) {
                        ...
                        Circulo circulo = new Circulo(raio, comprimento, material, peso_especifico, valor_kilo);
                        ...
                        System.out.println("Digite o peso específico: ");
                        valor_kilo = scanner.nextDouble();
                        Quadrado quadrado = new Quadrado(comprimento, material, peso_especifico, valor_kilo);
                        ...
                        System.out.println("Digite o peso específico: ");
                        valor_kilo = scanner.nextDouble();
                        Retangulo retangulo = new Retangulo(base, altura, comprimento, material, peso_especifico, valor_kilo);
                ...
                case 3:
                    ...
                    if (indiceAtualizar >= 0 && indiceAtualizar < materiais.size()) {
                        GestaoMateriais item = materiais.get(indiceAtualizar);
